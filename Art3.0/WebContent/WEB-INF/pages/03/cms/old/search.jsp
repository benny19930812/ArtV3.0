...
<%-- 	<form method="post" action="<c:url value="/03/cms/SearchCreativeShopByName.ctrl"/>"> --%>
<!-- 		<label>請輸入商店名稱: </label> <input type="text" placeholder="請輸入商店名稱 " -->
<!-- 			name="name"> <span id=idsp class="colorGray"></span> <br /> -->
<!-- 	</form> -->
<%-- 	<form method="post" action="<c:url value="/03/cms/SearchCreativeShopById.ctrl"/>"> --%>
...
<!-- 	<form> -->
<!-- 		<table> -->
<%-- 			<tr><td><a href="<c:url value='/03/cms/Index' />">返回系統首頁</a></td></tr> --%>
<!-- 		</table> -->
<!-- 	</form> -->
<!-- </body> -->
<!-- </html> -->