...
public class CreateReservationTable {
	...
	public void createReservationTableForDB() {
		try (Connection connection = getDataSource().getConnection();) {
			Statement stmt = connection.createStatement();

			String sql = "CREATE TABLE CS_RESERVATION_TABLE (ReservationNo NUMBER GENERATED ALWAYS AS IDENTITY(START WITH 1 INCREMENT BY 1) PRIMARY KEY NOT NULL,  "
