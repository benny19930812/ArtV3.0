...
public class SearchShop {
	...
	@RequestMapping(path = "/03/cms/shop/SearchAllCreativeShops.ctrl", method = RequestMethod.POST)
	public String searchAllCreativeShops(Model m) {
		try {
		...
		return "03/cms/shop/search_return";
	}

	@RequestMapping(path = "/03/cms/shop/SearchCreativeShopById.ctrl", method = RequestMethod.POST)
	public String searchCreativeShopById(@RequestParam(name = "shopId") String shopId, Model m) {
	...
	@RequestMapping(path = "/03/cms/shop/SearchCreativeShopByName.ctrl", method = RequestMethod.POST)
	public String searchCreativeShopByName(@RequestParam(name = "name") String name, Model m) {
